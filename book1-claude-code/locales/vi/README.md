# Kỹ thuật Khung kiểm soát (Harness Engineering): Hướng dẫn Thiết kế cho Claude Code

![Cover: Harness Engineering: A Design Guide to Claude Code](assets/cover-wxb-en.svg)

Subtitle: Các nguyên lý kỹ thuật cho các hệ thống lập trình AI có thể kiểm soát được đúc kết từ thiết kế runtime cấp độ mã nguồn
